...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2019 at 10:55 AM
...
) ENGINE=InnoDB AVG_ROW_LENGTH=97 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AVG_ROW_LENGTH=411 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AVG_ROW_LENGTH=99 DEFAULT CHARSET=utf8;
...
ALTER TABLE `countrylanguage`
  ...
  ADD KEY `CountryLanguage_CountryCode` (`CountryCode`);
